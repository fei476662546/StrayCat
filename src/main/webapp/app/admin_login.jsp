...
<%--        <a target="_blank" href="${pageContext.request.contextPath}/app/register.jsp">注册</a>--%>
        ...
        <a target="_blank" href="${pageContext.request.contextPath}/app/login.jsp">用户登录</a>
...
<div class="banner">
    ...
    <div class="login-aside">
        ...
        <div id="o-box-down"  style="table-layout:fixed;">
            ...
            <form  id="login" class="registerform" action="${pageContext.request.contextPath}/admin/login" method="post">
                <div class="fm-item">
                    <label  class="form-label">管理员账号：</label>
                    <input type="text" placeholder="请输入账号" maxlength="100" id="username" name="name" class="i-text" >
