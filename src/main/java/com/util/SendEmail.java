 ...
 * time on 2020-3-25  14:23
 */

public class SendEmail {
    //发件人的邮箱和授权码
    private final String myEmailAccount = "476662546@qq.com";//发送的邮箱
    private final String myEmailPassword = "vifjqympmdmebggb";//授权码
    ...
    public  MimeMessage createMessage(Session session, String sendMail, String receiveMail, String info) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "流浪猫狗领养网站邮箱验证", "UTF-8"));
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "xx用户", "UTF-8"));
        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
        message.setSubject("您的邮箱验证码", "UTF-8");
 ...
 class Test {
    public static void main(String[] args) {
        ...
        //设置要发送的邮箱
        sendEmail.setReceiveMailAccount("2391407197@qq.com");
        //创建6位发验证码
        Random random=new Random();
        String str="";
        for(int i=0;i<6;i++) {
